...
class DMPlsOutput
{
 public:
  ...
  std::tuple <TH2F*,TH2F*,TH2F*,TH2F*,TH2F*,TH2F*,TH1F*,TH1F*,TH1F*,TH1F*,TH1F*,TH1F*,TH1F*> createHistos (double len_view_x, double len_view_y, double totXbin, double totYbin);
  std::tuple <ofstream,ofstream,ofstream,ofstream,ofstream,ofstream> createLogs ();
